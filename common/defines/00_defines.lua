...
NDiplomacy = {
	...
	VOLUNTEERS_PER_COUNTRY_ARMY = 0.025,			-- Each army unit owned by the source country contributes this amount of volunteers to the limit.
...
NCountry = {
	...
	MIN_MAJOR_COUNTRIES	= 12,						-- MIN_MAJOR_COUNTRIES countries with most factories will be considered as major countries
